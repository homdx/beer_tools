...
def data_temp_interna():
    '''
        gera dados para o gráfico da temperatura interna, inicialmente lendo do banco de dados local, pesteriormente 
        a leitura será feita via internet
    '''
    try: 
    ...
    cur = conn.cursor() # não sei exatemente o que o cur faz
